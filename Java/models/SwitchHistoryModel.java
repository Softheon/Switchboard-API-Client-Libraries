 ...
 */
public class SwitchHistoryModel {
    /**
     * Gets or sets the switch history identifier.
     */
    @JsonProperty(value = "switchHistoryId")
    private int switchHistoryId;
    ...
    /**
     * Get gets or sets the switch history identifier.
     *
     * @return the switchHistoryId value
     */
    public int switchHistoryId() {
        return this.switchHistoryId;
    }

    /**
     * Set gets or sets the switch history identifier.
     *
     * @param switchHistoryId the switchHistoryId value to set
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withSwitchHistoryId(int switchHistoryId) {
        this.switchHistoryId = switchHistoryId;
        return this;
    }
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withSwitchId(int switchId) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withBoardId(int boardId) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withCreatedUserId(int createdUserId) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withModifiedUserId(int modifiedUserId) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withDescription(String description) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withComment(String comment) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withCreatedDate(DateTime createdDate) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withModifiedDate(DateTime modifiedDate) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withValue(String value) {
        this.value = value;
        return this;
    }
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withValueType(String valueType) {
     ...
     * @return the SwitchHistoryModel object itself.
     */
    public SwitchHistoryModel withVersion(String version) {
