...
namespace Softheon.API.Switchboard.Client.Models
{
    ...
    public partial class BoardModel
    {
        ...
        public BoardModel(int boardId = default(int), int accountId = default(int), int createdUserId = default(int), int modifiedUserId = default(int), string name = default(string), string description = default(string), System.DateTime createdDate = default(System.DateTime), System.DateTime modifiedDate = default(System.DateTime))
        {
            BoardId = boardId;
            AccountId = accountId;
