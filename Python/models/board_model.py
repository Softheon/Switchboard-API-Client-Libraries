...
class BoardModel(Model):
    ...
    def __init__(self, board_id=None, account_id=None, created_user_id=None, modified_user_id=None, name=None, description=None, created_date=None, modified_date=None):
